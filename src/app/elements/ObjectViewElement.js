...
<div class="properties" object-hint="${objectType}">
  ...
  <key-value uuid=${this.uuid} key-name="Matrix Auto Update" value="${object.matrixAutoUpdate}" type="boolean" property="matrixAutoUpdate"></key-value>
  <key-value uuid=${this.uuid} key-name="Render Order" value="${object.renderOrder || 0}" type="number" property="renderOrder"></key-value>
  <key-value uuid=${this.uuid} key-name="Visible" value="${object.visible}" type="boolean" property="visible"></key-value>
  <key-value uuid=${this.uuid} key-name="Receive Shadow" value="${object.receiveShadow}" property="receiveShadow" type="boolean"></key-value>
  <key-value uuid=${this.uuid} key-name="Cast Shadow" value="${object.castShadow}" type="boolean" property="castShadow"></key-value>
  <key-value uuid=${this.uuid} key-name="Frustum Culled" value="${object.frustumCulled}" type="boolean" property="frustumCulled"></key-value>
